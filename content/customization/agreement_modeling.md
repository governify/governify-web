...
```
You can see a complete guide about metric modelling in the [Metrics section](/customization/agreement_modeling/metrics).
...
You can see a complete guide about guarantees modelling in the [Guarantees section](/customization/agreement_modeling/guarantees).